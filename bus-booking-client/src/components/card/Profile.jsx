      ...
      <ul className="card__list">
        {
            ProfileInfo.map((info , index) => (
              <li className="card__list_item" key={`${info.id}-${index}`}>
                ...
                <span className="list_text pt-1"><b>Set Clear Goals </b> <br />Define your objectives and create actionable steps to reach them.</span>
              </li>
            ))
        }
      </ul>

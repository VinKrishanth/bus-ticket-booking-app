...
export default function BookingPayment() {
  ...
  return (
    <div className={`flex flex-col min-h-[80vh] md:px-8 pt-24 2xl:mx-32`}>
      <TopHeader />
      <div className={`flex  md:flex-row sm:flex-col-reverse flex-col  justify-start items-start pt-8 mx-8 2xl:gap-16 gap-8`}>
        ...
        <div className={`min-h-32 xl:min-w-72 sm:border-2 rounded-xl sm:px-4 sm:py-4 border-gray-200 min-w-full sm:translate-y-0 -translate-y-20 `} >
          <div className={`border-b-2 border-gray-200`}>
